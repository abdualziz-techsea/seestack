package com.allstak.modules.requests.kafka;

import com.allstak.modules.requests.writer.HttpRequestClickHouseWriter;
...
public class HttpRequestKafkaConsumer {
    ...
    @KafkaListener(topics = "allstak.http_requests", groupId = "allstak-http-requests-consumer", concurrency = "3")
