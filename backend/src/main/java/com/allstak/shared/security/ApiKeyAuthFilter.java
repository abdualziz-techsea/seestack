...
/**
 * Validates the X-AllStak-Key header on /ingest/** endpoints.
...
public class ApiKeyAuthFilter extends OncePerRequestFilter {
    ...
    public static final String PROJECT_ID_ATTRIBUTE = "allstak.projectId";
    public static final String API_KEY_HEADER = "X-AllStak-Key";
