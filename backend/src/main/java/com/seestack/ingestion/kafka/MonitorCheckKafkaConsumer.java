...
import com.seestack.ingestion.clickhouse.MonitorCheckClickHouseWriter;
...
public class MonitorCheckKafkaConsumer {
    ...
    @KafkaListener(topics = "seestack.monitor-checks", groupId = "seestack-consumers", concurrency = "1")
