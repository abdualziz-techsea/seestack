package com.seestack.modules.cron.kafka;

import com.seestack.modules.cron.writer.CronPingClickHouseWriter;
...
public class CronPingKafkaConsumer {
    ...
    @KafkaListener(topics = "seestack.cron_pings", groupId = "seestack-cron-pings-consumer", concurrency = "3")
