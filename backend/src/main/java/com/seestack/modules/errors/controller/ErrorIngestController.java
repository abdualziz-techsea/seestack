...
import com.seestack.ingestion.kafka.ErrorKafkaEvent;
import com.seestack.modules.errors.dto.ErrorIngestRequest;
import com.seestack.shared.security.ApiKeyAuthFilter;
...
public class ErrorIngestController {
    ...
    private static final String TOPIC = "seestack.errors";

    private final com.seestack.modules.errors.service.ErrorFingerprintService fingerprintService;
    private final KafkaTemplate<String, String> kafkaTemplate;
    private final ObjectMapper objectMapper;

    public ErrorIngestController(
            com.seestack.modules.errors.service.ErrorFingerprintService fingerprintService,
